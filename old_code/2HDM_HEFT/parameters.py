...
GH1 = Parameter(name = 'GH1',
                nature = 'internal',
                type = 'real',
                value = '-(aS*(1 + (13*mh1**6)/(16800.*MT**6) + mh1**4/(168.*MT**4) + (7*mh1**2)/(120.*MT**2)))/(3.*cmath.pi*v)',
                texname = 'G_{\\text{H1}}')

GH2 = Parameter(name = 'GH2',
                nature = 'internal',
                type = 'real',
                value = '-(aS*(1 + (13*mh2**6)/(16800.*MT**6) + mh2**4/(168.*MT**4) + (7*mh2**2)/(120.*MT**2)))/(3.*cmath.pi*v)',
                texname = 'G_{\\text{H2}}')

GH3 = Parameter(name = 'GH3',
                nature = 'internal',
                type = 'real',
                value = '-(aS*(1 + mh3**6/(560.*MT**6) + mh3**4/(90.*MT**4) + mh3**2/(12.*MT**2)))/(2.*cmath.pi*v)',
                texname = 'G_{\\text{H3}}')
